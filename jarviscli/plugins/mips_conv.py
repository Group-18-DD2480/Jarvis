...
branch_coverage = {} #values <100 used for assemblyToHex and values >100 for hexToAssembly
...
def write_coverage():
    ...
    with open("branch_coverage.log", "a") as f:
        f.write(f"MipsConverter covered {covered_branches} branches out of {total_branches}\n")
